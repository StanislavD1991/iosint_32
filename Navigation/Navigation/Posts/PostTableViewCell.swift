...
class PostTableViewCell: UITableViewCell {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            postImage.leftAnchor.constraint(equalTo: self.contentView.leftAnchor, constant: 35),
            postImage.rightAnchor.constraint(equalTo: self.contentView.rightAnchor, constant: -35),
